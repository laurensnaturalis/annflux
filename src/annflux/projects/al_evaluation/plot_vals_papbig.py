...
def m():
    ...
    accuracy_avg2, recall_avg2, t = compute_averages("experiments/papbig_knnexp_10_step_500_strategy_fre_strat_linear_at_(0, 5, 10, 15)")
    ...
    plt.subplot(221)
    plt.plot(t.labeled_train_set_size, accuracy_avg, label="linear at (0, 5, 10, 15), exp = 5")
    plt.plot(t.labeled_train_set_size, accuracy_avg2, label="linear at (0, 5, 10, 15), exp = 10")
