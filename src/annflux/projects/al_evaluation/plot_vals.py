...
def m():
    accuracy_avg, recall_avg, t = compute_averages("experiments/step_500_strategy_fre_strat_linear_at_10")
    ...
    accuracy_avg4, recall_avg4, t = compute_averages("experiments/step_500_strategy_fre_strat_linear_at_(0, 5, 10)")
    plt.subplot(221)
